...
import authUser from '../middleware/authUser.js'; // Assuming you have authUser middleware
...
userRouter.get("/view-prescription/:appointmentId", authUser, viewPrescription);
